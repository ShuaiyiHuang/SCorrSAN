...
class CorrespondenceDataset(Dataset):
    ...
    def __init__(self, benchmark, datapath, thres, device, split, augmentation, feature_size,receptive_field_size=35):
        ...
        self.kps_to_flow = KeypointToFlow(receptive_field_size=receptive_field_size, jsz=256//feature_size, feat_size=feature_size, img_size=self.imside)
