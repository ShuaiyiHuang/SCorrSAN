...
def load_checkpoint(model, optimizer, scheduler, filename='model_latest.pth'):
    ...
    if os.path.isfile(filename):
        ...
        try:
            ...
            best_val_pck_merge = checkpoint['best_val_pck_merge']
            best_epoch_merge = checkpoint['best_epoch_merge']
        ...
        try:
            best_model_type = checkpoint['best_model_type']
        except:
    ...
    return model, optimizer, scheduler, start_epoch, best_val_pck, best_epoch, best_val_pck_merge, best_epoch_merge, best_model_type
