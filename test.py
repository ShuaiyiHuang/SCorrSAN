...
from utils_training.utils import parse_list, log_args, boolean_string
...
if __name__ == "__main__":
    ...
    # Model
    model = SCorrSAN(sce_ksize = args_model.sce_ksize, sce_outdim = args_model.sce_outdim, freeze=True)
